# Кароч Виктор шось я тут по видосикам ебанул, картинки если шо подкину бо по видосам чел ставил якись хитровыебаные гифки, я их нашел если шо.
...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        btn_open_dialog = tk.Button(toolbar, text='Добавить задание', command=self.open_dialog, bg='#d7d8e0', bd=0,
        ...
        btn_delete = tk.Button(toolbar, text='Удалить задание', bg='#d7d8e0', bd=0, image=self.delete_img,
        ...
        self.tree.heading('costs', text='сделано/в процессе')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        self.title('Добавить сделано/в процессе')
        self.geometry('400x220+400+300')
        self.resizable(False, False)

        label_description = tk.Label(self, text='Наименование:')
        label_description.place(x=50, y=50)
        label_select = tk.Label(self, text='сделано/в процессе:')
        ...
        self.combobox = ttk.Combobox(self, values=[u'Сделано', u'В процессе'])
...
class Update(Child):
    ...
    def init_edit(self):
        self.title('Редактировать задание')
